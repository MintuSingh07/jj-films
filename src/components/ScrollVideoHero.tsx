...
const SERVICES_DATA = [
  {
    ...
    tag: "Photography",
    shortDescription:
      "150+ luxury estates completed.\nElevating every property to its absolute best.",
    longDescription:
...
const SERVICES_LIST = [
  {
    ...
    description:
      "Premium wide-angle and detail interior/exterior photography utilizing advanced bracketed exposures, high-end optical sensors, and architectural perspective correction to showcase luxury properties in their most pristine visual light.",
  },
  {
    title: "Real Estate Videography",
    description:
      "Custom-engineered walkthrough videos combining smooth motorized gimbal movements, dynamic lens shifts, and volumetric lighting tracks designed to create immersive virtual experiences for prospective buyers.",
  },
  {
    title: "Drone Photography & Videography",
    description:
      "FAA-certified aerial cinematography capturing majestic sweeping sweeps, property boundaries, and neighborhood accessibility profiles on ultra-high definition 4K camera sensors for complete spatial overview.",
  },
  {
    title: "Luxury Property Films",
    description:
      "Bespoke, cinematic storytelling productions featuring custom sound designs, emotional lifestyle scripts, and elite color grades tailored exclusively for high-end luxury villas, penthouses, and landmark resorts.",
  },
  {
    title: "Builder & Developer Project Shoots",
    description:
      "High-impact marketing assets for developers, highlighting structural engineering scale, premium raw materials, and completed phases to build market authority and drive early off-plan sales.",
  },
  {
    title: "Architectural Photography",
    description:
      "Fine-art photography focusing on design details, dynamic shadow geometry, material textures, and natural lighting shifts, tailored for elite architects, structural engineers, and design catalogs.",
  },
  {
    title: "Interior Photography",
    description:
      "Curated interior captures highlighting spatial layout, custom furniture details, textures, and lighting design, crafted specifically to elevate portfolios for designers and luxury staging firms.",
  },
  {
    title: "Property Marketing Reels",
    description:
      "High-conversion, fast-paced vertical video reels (9:16) optimized with trending pacing and text layouts, engineered to maximize engagement, virality, and lead acquisition on social media channels.",
  },
  {
    title: "Virtual Property Tours",
    description:
      "High-resolution 3D virtual walkthroughs mapping spatial flows and architectural layouts, allowing prospective international buyers to inspect every corner of the property remotely.",
  },
  {
    title: "Construction Progress Documentation",
    description:
      "Periodic, chronologically structured high-definition photography and drone tracking reports designed to document construction milestones for investors, stakeholders, and regulatory agencies.",
  },
  {
...
const COMMERCIAL_SERVICES = [
  {
    ...
    description:
      "High-concept cinematic brand profiles detailing your company's heritage, cultural values, and creative philosophy, engineered to forge a strong emotional connection with global audiences.",
  },
  {
    title: "Product Launch Videos",
    description:
      "Visually arresting product reveals utilizing high-speed macro cinematography, volumetric light designs, and custom CGI integration to generate maximum market hype and customer engagement.",
  },
  {
    title: "Social Media Campaigns",
    description:
      "A collection of short-form, high-retention video assets (Reels, TikToks, Shorts) designed around target demographics to maximize viewer retention, sharing frequency, and direct conversion rates.",
  },
  {
    title: "TV & Broadcast Commercials",
    description:
      "Full-scale commercial productions meeting rigorous network standards, featuring professional casting, art direction, and post-production optimization to capture broad television and digital audiences.",
  },
  {
    title: "Corporate Event Cinematography",
    description:
      "Comprehensive multi-camera coverage capturing the energy, keynotes, and human interactions of corporate summits, panel sessions, and galas, delivered in highly polished event recap films.",
  },
  {
    title: "Testimonial & Case Study Videos",
    description:
      "Authentic, interview-driven customer success narratives capturing verified metrics and human satisfaction to establish absolute market authority and trust for enterprise products.",
  },
  {
    title: "Company Culture & Recruitment",
    description:
      "Behind-the-scenes profiles of daily workflows, team collaborations, and executive visions, designed to showcase an inspiring work environment and attract elite global talent.",
  },
  {
    title: "Aerial & Drone Videography",
    description:
      "Licensed, safe, and dynamic aerial drone filming capturing factory complexes, corporate headquarters, and site developments from dramatic, high-angle cinematic vantage points.",
  },
  {
    title: "Animated Explainer Videos",
    description:
      "Custom motion graphic sequences, clean vector animations, and voiceover designs that simplify complex product features, app workflows, or technical architectures for easy understanding.",
  },
  {
    title: "Behind-the-Scenes (BTS) Content",
    description:
      "Engaging documentary logs detailing the scale, effort, and creative milestones of your marketing campaigns, adding human relatability and brand transparency.",
  },
];
...
const WEDDING_SERVICES = [
  {
    ...
    description:
      "A masterfully edited, non-linear cinematic story of your wedding day, set to custom licensed soundtracks that weave together emotional vows, laughter, and premium visual compositions.",
  },
  {
    title: "Full-Feature Documentary Film",
    description:
      "A comprehensive, chronologically polished archive of your entire celebration, preserving full multi-camera records of the ceremony, toasts, first dances, and reception moments in pristine clarity.",
  },
  {
    title: "Pre-Wedding Cinematic Shoot",
    description:
      "A relaxed, fashion-forward couple profile shot in high-end scenic locations, designed to capture your unique chemistry and relationship story prior to the main wedding celebrations.",
  },
  {
    title: "Aerial Drone Cinematography",
    description:
      "Majestic 4K aerial compositions highlighting the layout, scale, and natural landscaping of your wedding venue, providing a grand context to your digital heirloom.",
  },
  {
    title: "Multi-Day Event Coverage",
    description:
      "Dedicated production crews documenting welcome dinners, wedding preparations, traditional rituals, morning brunches, and post-celebration parties to capture the full story of your guests.",
  },
  {
    title: "Same-Day Edit (SDE) Film",
    description:
      "A high-speed editing feat where highlights from the morning prep and ceremony are woven into a cinematic teaser and screened live to your guests during the reception dinner.",
  },
  {
    title: "Destination Wedding Cinematography",
    description:
      "Travel-ready, expert production crews equipped with specialized gear setups to document luxury unions in remote locations, varying climates, and historic venues globally.",
  },
  {
    title: "High-Fidelity Audio Vows Capture",
    description:
      "Pristine multi-source sound engineering utilizing discrete wireless lapel microphones and soundboard lines to capture clear whispers of vows, letter readings, and family speeches.",
  },
  {
    title: "Bridal Portraits & Preparations",
    description:
      "Intimate, macro-focused portrait capture highlighting dress textures, accessory details, emotional first-looks, and candid preparation moments before walking down the aisle.",
  },
  {
    title: "Anniversary & Legacy Vows Renewal",
    description:
      "Cinematic tribute packages documenting legacy vows, long-term family unions, and renewal celebrations, designed to preserve visual history for future generations.",
  },
];
    ...
    gallery: [
      {
        ...
        description:
          "High-ceiling architectural geometries captured at sunset, highlighting structural glass and ambient lighting.",
      },
      {
        title: "Vortex",
        ...
        image: "/images/real_estate.png",
        description:
          "Dynamic aerial tracking shots emphasizing location scale, traffic accessibility, and surrounding landscape.",
      },
      {
        title: "Mirage",
        ...
        image: "/images/real_estate_hero.png",
        description:
          "Ultra-wide angle interior framing showcasing spatial flow, bespoke textures, and panoramic ocean vistas.",
      },
    ],
  },
  {
    ...
    gridIntro:
      "High-concept campaigns, social media assets, and corporate documentaries designed to amplify your brand presence.",
    ...
    gallery: [
      {
        ...
        image: "/images/commercial_films.png",
        description:
          "High-speed macro cinematography capturing condensation droplets and volumetric studio lighting.",
      },
      {
        title: "Aether",
        ...
        image: "/images/commercial_films.png",
        description:
          "Dynamic motion control tracking shots highlighting fabric weave details and active athlete geometry.",
      },
      {
        title: "Nexus",
        ...
        image: "/images/commercial_films.png",
        description:
          "Cinematic tracking of luxury EV sweeping through volumetric mountain curves at blue hour.",
      },
    ],
  },
  {
    ...
    gridIntro:
      "From intimate cinematic highlights to comprehensive documentary features, explore how we preserve your legacy.",
    ...
    gallery: [
      {
        ...
        image: "/images/wedding_films.png",
        description:
          "Intimate golden hour portraits of the couple sweeping through antique olive groves.",
      },
      {
        title: "Solace",
        ...
        image: "/images/wedding_films.png",
        description:
          "Prism-filtered closeups of vows capture, preserving emotional details in high-fidelity 4K celluloid.",
      },
      {
        title: "Rhapsody",
        ...
        image: "/images/wedding_films.png",
        description:
          "Multi-angle drone sweeps capturing grand dinner setups and reception firework reveals.",
      },
    ],
  },
];
...
export default function ScrollVideoHero() {
  ...
  useEffect(() => {
    ...
    const handleCriticalLoad = () => {
      ...
      setLoadedCount(
        Math.round((loadedCritical / totalCritical) * TOTAL_FRAMES),
      );
  ...
  useEffect(() => {
    ...
    tl.set(".scroll-guide", { display: "none" }, 2.0);
    ...
    const updateScrollWarp = () => {
      ...
      scrollProgress.current.current +=
        (clampedTarget - scrollProgress.current.current) * 0.1;
  ...
  const handleCardClick = (index: number, element: HTMLDivElement) => {
    ...
    // Preload first slide image for details hero screen
    const img = new Image();
    img.src = "/image-1.jpg";
  ...
  useEffect(() => {
    ...
    const localLenis = new Lenis({
      wrapper: el,
      content:
        el.querySelector(".service-detail-content-inner") ||
    ...
    const handleScroll = (e: any) => {
      ...
      snapTimeout = setTimeout(() => {
        ...
        if (progress > 0.05 && progress < 0.95) {
          ...
          const targetScroll =
            sectionScrollTop + targetIndex * (totalScrollable / 2);
  ...
  useEffect(() => {
    ...
    const galleryLength = CARD_DETAILS[activeCard]?.gallery?.length || 0;
    if (galleryLength <= 1) return;

    const interval = setInterval(() => {
      setCurrentHeroSlide((prev) => (prev + 1) % galleryLength);
    }, 5000);
  ...
  return (
    ...
    >
      ...
      <div
        style={{ zIndex: 60 }}
        className="fixed top-6 left-1/2 -translate-x-1/2 w-[94%] max-w-7xl global-navbar opacity-0 pointer-events-none"
      >
        <nav className="w-full bg-[#050507]/60 backdrop-blur-xl border border-white/10 rounded-full py-2.5 px-4 md:px-6 lg:px-12 flex items-center justify-between shadow-[0_20px_50px_rgba(0,0,0,0.8)] relative pointer-events-auto transition-all duration-500 hover:border-accent/30 hover:shadow-[0_20px_50px_rgba(197,168,128,0.05)]">
          {/* Logo Wrapper */}
          <div className="flex-1 flex justify-start">
            <div
              ...
              className="whitespace-nowrap flex-shrink-0 font-display tracking-[0.25em] font-light text-foreground text-[11px] lg:text-base uppercase cursor-pointer hover:text-accent transition-colors"
            >
              JJ FILMS
            </div>
          </div>

          {/* Center Navigation Links Wrapper */}
          ...
          <div className="flex-1 flex justify-end items-center gap-3 lg:gap-6">
            ...
            <button
              ...
              className="whitespace-nowrap group inline-flex items-center gap-1.5 font-body text-[8.5px] lg:text-[10px] tracking-[0.12em] uppercase text-foreground/60 hover:text-accent transition-colors duration-300 cursor-pointer border-none bg-transparent outline-none p-0"
            >
              <span className="font-sans text-[13px] leading-none transition-transform duration-500 group-hover:rotate-90">
                ✕
              </span>
      ...
      <div className="text-blocks-container absolute inset-0 z-10 pointer-events-none p-10 md:p-24 flex items-end justify-start overflow-hidden">
        ...
        <div className="absolute text-left opacity-0 translate-y-10 text-block-1 select-none bottom-20 md:bottom-32 left-10 md:left-24 max-w-xl">
          ...
          <p className="font-body text-xs md:text-sm text-[#eae6e1]/70 mt-4 leading-relaxed">
            Trusted by industry leaders including Tanishq, Titan, Hitachi, and
            Highly to deliver high-fidelity cinematic campaigns globally.
          </p>
        </div>
        ...
        <div className="absolute text-left opacity-0 translate-y-10 text-block-2 select-none bottom-20 md:bottom-32 left-10 md:left-24 max-w-xl">
          ...
          <p className="font-body text-xs md:text-sm text-[#eae6e1]/70 mt-4 leading-relaxed">
            Pioneering complete transparency, strict time commitments, and no
            hidden costs. Once assigned, we own the execution end-to-end so you
        ...
        <div className="absolute text-left opacity-0 translate-y-10 text-block-3 select-none bottom-20 md:bottom-32 left-10 md:left-24 max-w-xl">
          ...
          <p className="font-body text-xs md:text-sm text-[#eae6e1]/70 mt-4 leading-relaxed">
            Harnessing cutting-edge visual systems with a global footprint, an
            unbroken record of 100% satisfaction, and zero negative reviews.
          </p>
        </div>
      </div>

      {/* Floating Scroll Guide */}
      <div className="scroll-guide absolute bottom-10 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-3.5 font-body text-[10px] tracking-[0.3em] text-foreground/60 select-none text-center">
        ...
        <div className="w-[20px] h-[32px] border border-foreground/20 rounded-[10px] flex justify-center p-1.5 opacity-80 hover:opacity-100 transition-opacity duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]">
      ...
      >
          ...
          return (
            ...
            >
              ...
              <div
                ...
                style={{
                  backgroundImage: loadReelImages
                    ? `url('${service.image}')`
                    : "none",
                }}
              />
              ...
              <div className="services-content relative z-20 text-left max-w-sm">
                <span className="font-body text-[10px] md:text-xs font-semibold tracking-[0.3em] text-accent/90 uppercase">
                  {service.tag}
                </span>
                <h3 className="font-display text-3xl md:text-5xl text-foreground mt-2 font-light tracking-wide">
                  {service.title}
                </h3>
                <p className="font-body text-foreground/80 mt-4 text-sm md:text-base leading-relaxed max-w-xs whitespace-pre-line">
                  {service.shortDescription}
                </p>
                {/* Visual Card CTA */}
                <div className="mt-8 overflow-hidden">
                  <span className="inline-flex items-center gap-2 font-mono text-[10px] md:text-xs tracking-[0.25em] uppercase text-accent group-hover:text-white transition-colors duration-500 font-semibold">
                    CLICK TO EXPLORE
                    <span className="transform translate-x-0 group-hover:translate-x-1.5 transition-transform duration-500">
                      →
                    </span>
                  </span>
                </div>
        ...
        {/* Bottom Footer Info */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-30 flex flex-col items-center gap-3 font-body text-[8px] md:text-[9px] tracking-[0.3em] text-foreground/50 select-none text-center services-footer">
          ...
          {activeCard !== null && (
            <>
              ...
              <image
                ref={imageRef}
                href={
                  loadReelImages ? SERVICES_DATA[activeCard].image : undefined
                }
                  ...
                  {showAllServicesView ? (
                    ...
                    <div className="w-full min-h-screen pt-32 pb-24 px-8 md:px-24 bg-[#030303] animate-fade-in relative">
                      ...
                      <div className="max-w-7xl mx-auto relative z-10">
                        ...
                        <div className="mb-20 md:mb-32">
                          ...
                          <p className="font-body text-sm md:text-base text-foreground/80 max-w-xl leading-relaxed mt-6">
                            A complete breakdown of our high-fidelity production
                            services, cinematic strategies, and specialized
                            media craft.
                          </p>
                          <p className="font-body text-xs md:text-sm text-foreground/60 max-w-3xl leading-relaxed mt-4">
                            Every service is executed with a relentless pursuit
                            of creative prestige and technical precision. We
                            deploy advanced cinematography packages, tailored
                            grading, and specialized director treatments to
                            capture properties and narratives in their most
                            premium light, ensuring every detail reflects
                            absolute architectural and emotional resonance.
                          </p>
                    ...
                    <>
                      ...
                      >
                          ...
                          return (
                            ...
                            >
                              ...
                              <div
                                ...
                                style={{
                                  backgroundImage: `url('/image-${idx + 1}.jpg')`,
                              ...
                              {/* Subtle Bottom Overlay (covering only bottom portion) */}
                              <div
                                className="absolute inset-x-0 bottom-0 h-[45%] pointer-events-none z-20"
                                style={{
                                  background:
                                    "linear-gradient(to top, rgba(3, 3, 3, 0.95) 0%, rgba(3, 3, 3, 0.7) 40%, rgba(3, 3, 3, 0) 100%)",
                                }}
                              />

                              {/* Content in the lower-left */}
                              <div className="absolute bottom-16 md:bottom-24 left-10 md:left-24 right-10 z-30 text-left max-w-2xl pointer-events-none">
                                <span className="font-mono text-[10px] md:text-xs tracking-[0.35em] text-accent uppercase block mb-3 font-semibold">
                                  {slide.tagline}
                                </span>
                                <h1 className="font-display text-4xl md:text-6xl font-light italic tracking-wide text-[#eae6e1] leading-tight">
                                  {slide.title}
                                </h1>
                                <p className="font-body text-sm md:text-base text-foreground/80 mt-4 leading-relaxed max-w-xl">
                                  {slide.description}
                                </p>
                              </div>
                            </div>
                        ...
                        {/* Top layout navbar protection vignette */}
                        <div
                          className="absolute inset-x-0 top-0 h-32 pointer-events-none z-20"
                          style={{
                            background:
                              "linear-gradient(to bottom, rgba(3, 3, 3, 0.6) 0%, transparent 100%)",
                          }}
                        />

                        {/* Slide Indicators / Navigation Controls */}
                        {details.gallery.length > 1 && (
                          <div className="absolute bottom-10 right-10 md:right-24 z-30 flex items-center gap-3 select-none">
                            {details.gallery.map((_, idx) => (
                              <button
                                ...
                                className={`h-1.5 rounded-full transition-all duration-500 cursor-pointer border-none outline-none ${
                      ...
                      >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
                          {details.services.slice(0, 8).map((service, index) => {
                            const num = String(index + 1).padStart(2, "0");
                            return (
                              <div
                                key={index}
                                className="group relative flex flex-col bg-[#0a0a0c]/60 border border-accent/15 rounded-[4px] overflow-hidden transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] hover:bg-[#121215]/80 hover:border-accent/40 hover:-translate-y-1 hover:shadow-[0_12px_24px_-10px_rgba(197,168,128,0.15)] animate-fade-in"
                              >
                        ...
                        >
                          <div className="sticky top-0 h-screen w-full flex flex-col lg:flex-row overflow-hidden">
                            ...
                            <div className="w-full lg:w-1/2 h-[45vh] lg:h-full flex items-center justify-start px-8 md:px-20 relative bg-[#030303]">
                              ...
                              <div className="absolute bottom-10 left-8 md:left-20 z-10 font-mono text-[8px] md:text-[9px] text-foreground/40 tracking-[0.25em] flex flex-col gap-1 text-left uppercase">
                          ...
                          <div className="lg:col-span-5 flex flex-col justify-between gap-12">
                            <div className="flex flex-col gap-6">
                              ...
                              <p className="font-body text-xs md:text-sm text-foreground/50 leading-relaxed max-w-md">
                                Have an upcoming campaign, a luxury listing, or
                                a wedding celebration? Reach out to schedule a
                                consultation with our production directors. We
                            ...
                            <div className="flex flex-col gap-6 max-w-sm pt-8 border-t border-white/5">
                              <div className="flex flex-col gap-1.5">
                                <span className="font-mono text-[7.5px] text-foreground/35 tracking-[0.25em] uppercase">
                                  DIRECT EMAIL
                                </span>
                                <a
                                  href="mailto:hello@jjfilms.co"
                                  className="font-serif text-base text-foreground hover:text-accent transition-colors duration-300 w-fit"
                                >
                                  hello@jjfilms.co
                                </a>
                              </div>
                          ...
                          <div className="lg:col-span-7">
                            <form
                              onSubmit={(e) => {
                                e.preventDefault();
                                alert(
                                  "Thank you! Your inquiry brief has been received. A production director will contact you shortly.",
                                );
                              }}
                            ...
                            >
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div className="flex flex-col gap-2">
                                  <label className="font-mono text-[8px] text-foreground/40 tracking-[0.2em] uppercase">
                                    Your Name
                                  </label>
                                  <input
                                    required
                              ...
                              <div className="flex flex-col gap-2">
                                ...
                                <select className="w-full bg-[#030303] border border-white/10 rounded-[4px] px-4 py-3 text-xs text-foreground focus:border-accent outline-none transition-colors duration-300">
                                  <option value="real_estate">
                                    Real Estate &amp; Architecture
                                  </option>
                                  <option value="commercial">
                                    Commercial Campaign / Brand Film
                                  </option>
                                  <option value="wedding">
                                    Luxury Wedding Film / Event
                                  </option>
                                  <option value="other">
                                    Other Creative Shoot
                                  </option>
                                </select>
                              </div>
                        ...
                        <div className="lg:col-span-5">
                          <div className="relative bg-[#08080a]/90 backdrop-blur-3xl border border-white/10 p-8 md:p-10 rounded-[12px] shadow-[0_20px_50px_rgba(0,0,0,0.8)] overflow-hidden group hover:border-accent/40 transition-all duration-700">
                            ...
                            <p className="font-body text-xs text-foreground/60 leading-relaxed mb-8">
                              We partner with select visionaries, architects,
                              and luxury brands to execute high-fidelity visual
                              assets. Drop a note to explore rates, schedules,
                            ...
                            <button
                              onClick={() => {
                                alert(
                                  "Thank you! Our project onboarding form will be available shortly.",
                                );
                              }}
